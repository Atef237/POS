...
{{--                                            <optgroup label="كل الاقسام"></optgroup>--}}
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="{{old('name')}}" name="name"  class="form-control" id="exampleInputEmail1" placeholder="الاسم ">
...
{{--                                        <input type="text" name="name" value="{{old('name')}}" class="form-control" id="exampleInputEmail1" placeholder="الاسم ">--}}
                                        <textarea name="description" class="form-control ckeditor"  placeholder="الوصف ">{{old('description')}}</textarea>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input name="purchase_price" value="{{old('purchase_price')}}" class="form-control">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input name="sale_price" value="{{old('sale_price')}}" class="form-control">
                                        @error("sale_price")
                                        <span class="text-danger">{{$message}}</span>
                                        @enderror
                                    </div>
                                    <div class="form-group">
                                        <label>المخزون</label>
                                        <input name="stock" value="{{old('sale_price')}}" class="form-control">
                                        @error("stock")
                                        <span class="text-danger">{{$message}}</span>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <img src="{{asset('uploads/product_images/product.png')}}" style="width: 100px" class="image-preview img-thumbnail">
