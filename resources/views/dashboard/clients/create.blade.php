                            ...
                            <form action="{{route('clients.store')}}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="address" class="form-control"  placeholder="العنوان ">{{old('address')}}</textarea>
                                    ...
                                    <div class="form-group">
                                        <img src="{{asset('uploads/client_images/client.png')}}" style="width: 100px" class="image-preview img-thumbnail">
